    ...
    <div className="bg-gradient-to-b via-white to-blue-50 min-h-screen pb-16">
      ...
      <div className="relative overflow-hidden bg-gradient-to-tr from-blue-800 to-indigo-700 py-20 text-white text-center shadow-xl">
        <div className="relative z-10 px-4">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Ashley’s Article Collection</h1>
          <p className="text-lg sm:text-xl">Dive into curated reads, powerful ideas & vibrant stories</p>
        </div>
      </div>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {filteredArticles.slice(0, visibleCount).map((article) => (
              <Link
                ...
                className="bg-white rounded-2xl shadow-md hover:shadow-2xl transition duration-300 overflow-hidden flex flex-col transform hover:-translate-y-1"
              >
                <img
                  src={article.image}
                  alt={article.title}
